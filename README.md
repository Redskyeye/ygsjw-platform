...
[![Build Status](https://img.shields.io/badge/build-passing-brightgreen)](https://github.com/Redskyeye/ygsjw-platform/actions)

> AI驱动的职业规划与指导平台，帮助用户发现职业潜能，制定个性化发展路径。

[📖 查看完整文档](docs/README.md) | [🚀 快速开始](#-开发环境设置) | [📖 API文档](docs/api/README.md)
...
- 项目主页: [https://github.com/Redskyeye/ygsjw-platform](https://github.com/Redskyeye/ygsjw-platform)
- 问题反馈: [Issues](https://github.com/Redskyeye/ygsjw-platform/issues)
- 邮箱: team@epic-ai.com
